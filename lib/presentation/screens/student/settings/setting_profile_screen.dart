...
import 'package:eventview_application_1/presentation/screens.dart';// Asegúrate de tener este servicio
                 ...
                 child: Column(
                    ...
                    children: [
                      ...
                      TextFieldCustom(
                        ...
                        hintText: _userData!['secondSurname'] ?? 'Lorem ipsum',
                        fontSize: 16.0,
                        constraints: BoxConstraints(minWidth: 100, maxWidth: 350),
                      ),
                      SizedBox(height: 16.0),
                      TextFieldCustom(
                        ...
                        hintText: _userData!['matriculaNomina'] ?? 'Lorem ipsum',
                        fontSize: 16.0,
                        constraints: BoxConstraints(minWidth: 100, maxWidth: 350),
                      ),
                      SizedBox(height: 16.0),
...
void _updateUserProfile() {
 ...
 if (_secondSurnameController.text.isNotEmpty) {
    updates['secondSurname'] = _secondSurnameController.text;
 }
