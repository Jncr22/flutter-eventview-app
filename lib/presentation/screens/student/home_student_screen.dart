      ...
      child: Scaffold(
        ...
        body: const Stack(
          children: [
            ...
            Center(widthFactor: double.infinity,
                ...
                child: Column(
                  ...
                  keyboardType: TextInputType.emailAddress
                     ...
                     Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                       children: [
                        ...
                        hintText: 'TI 91',
                        fontSize:  16.0,
                        constraints: BoxConstraints(minWidth:  100, maxWidth:  150), // Define restricciones de tamaño
                     ...
                     TextFieldCustom(
                        ...
                        hintText: 'TI 91',
                        fontSize:  16.0,
                        constraints: BoxConstraints(minWidth:  80, maxWidth:  170), // Define restricciones de tamaño
                        keyboardType: TextInputType.number
                      ),
                      ],
                     )
