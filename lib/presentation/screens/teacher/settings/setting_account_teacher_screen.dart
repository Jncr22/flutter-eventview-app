...
class SettingAccountTeacherView extends StatefulWidget {
  const SettingAccountTeacherView({super.key});

  @override
  _SettingAccountViewTeacherState createState() => _SettingAccountViewTeacherState();
}

class _SettingAccountViewTeacherState extends State<SettingAccountTeacherView> {
